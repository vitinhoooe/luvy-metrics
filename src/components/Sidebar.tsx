...
export default function Sidebar({ user, perfil }: any) {
  ...
  return (
    <div style={{
      ...
      {/* User info */}
      <div style={{ padding: '12px 20px 16px', borderBottom: '1px solid #e5e7eb' }}>
        <div style={{
          width: 36, height: 36, background: '#f5f3ff',
      ...
      <div style={{ padding: '12px 16px 20px' }}>
        {perfil?.plano !== 'ativo' && (
          <div style={{
            ...
            <div style={{ fontSize: 11, color: '#6b7280', marginBottom: 4 }}>Período de teste</div>
            <div style={{ fontSize: 14, fontWeight: 700, color: '#7c3aed' }}>{diasRestantes} dias restantes</div>
          </div>
        )}
